...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#FFE9E4] to-[#E4F7E9]">
      <TopNavigation 
        ...
        rightAction={
          <div className="flex items-center space-x-1.5 sm:space-x-2">
            ...
            <button className="w-9 h-9 sm:w-10 sm:h-10 md:w-11 md:h-11 bg-white/90 rounded-full flex items-center justify-center shadow-sm hover:shadow-md transition-all duration-200 flex-shrink-0">
      ...
      <div className="pt-14 sm:pt-16 md:pt-20 pb-20 sm:pb-24 space-y-4">
        <GreetingSection />
        <HealthCarousel />
        <HealthMetrics />
        <VitalMonitoring />
